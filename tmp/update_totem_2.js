...
const s1 = content.indexOf('// Images for series headers');
const e1 = content.indexOf('};\n', s1) + 2;

const s2 = content.indexOf('// Marketing Sections Data');
...
if (s1 !== -1 && s2 !== -1) {
    content = content.slice(0, s1) + newHeaderImages + content.slice(e1, s2) + newMarketingData + content.slice(e2);
