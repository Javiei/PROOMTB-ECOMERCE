        ...
        const fetchBikes = async () => {
            try {
                const { data, error } = await supabase
                    .from('bicicletas')
                    .select('*')
                    .eq('serie_id', 9); // Tavano ID

                if (error) throw error;
                setBikes(data || []);
            } catch (error) {
                console.error('Error fetching Tavano bikes:', error);
            } finally {
                setLoading(false);
            }
        };
        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="relative text-white pb-32 overflow-hidden">
                ...
                <div className="absolute inset-0 z-0">
                    <img
                        src="https://www.raymon-bicycles.com/_next/image?url=https%3A%2F%2Fb2b.raymon-bicycles.com%2Fmedia%2F8d%2F8a%2F60%2F1749728286%2FTavano_MainHeader.png&w=1200&q=100"
                        alt="Background"
                ...
                <div className="w-full relative z-10 mb-12">
                    <div className="relative h-[400px] md:h-[700px] flex items-center justify-center">
                        {bikes.length > 0 ? (
                            ...
                            <div className="text-center text-gray-400">No bikes found for Tavano series.</div>
                        )}
                    </div>
                </div>
                ...
                <div className="max-w-[1400px] mx-auto px-4 relative z-10 mb-20 hidden md:block">
                    <div className="flex items-center gap-4 md:gap-8 justify-center">
                        ...
                        <div className="flex-1 grid grid-cols-2 md:grid-cols-4 gap-4 py-6 bg-white backdrop-blur-md border border-black/10 rounded-tl-[2rem] rounded-br-[2rem] px-4 md:px-8 text-black max-w-4xl mx-auto">
                            {specs.map((spec, idx) => (
            ...
            {/* Marketing Section */}
            <div className="max-w-[1000px] mx-auto px-4 py-24 text-center">
                <h2 className="text-4xl md:text-6xl font-black text-black leading-tight mb-12">
                    The SUV feeling on<br />two wheels.
                </h2>

                <div className="text-lg text-black leading-relaxed space-y-8 max-w-4xl mx-auto mb-12">
                    <p>
...
export default SeriesDetailTavano;
