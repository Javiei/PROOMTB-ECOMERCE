        ...
        const fetchBikes = async () => {
            try {
                const { data, error } = await supabase
                    .from('bicicletas')
                    .select('*')
                    .eq('serie_id', 5); // Vamok ID

                if (error) throw error;
                setBikes(data || []);
            } catch (error) {
                console.error('Error fetching Vamok bikes:', error);
            } finally {
                setLoading(false);
            }
        };
        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="relative bg-black text-white pb-32 overflow-hidden">
                ...
                <div className="absolute inset-0 z-0">
                    <img
                        src="https://www.raymon-bicycles.com/_next/image?url=https%3A%2F%2Fb2b.raymon-bicycles.com%2Fmedia%2Fe8%2F63%2F20%2F1746520528%2Fairok_bg.png&w=3840&q=100"
                        alt="Background"
                ...
                <div className="w-full relative z-10 mb-12">
                    <div className="relative h-[400px] md:h-[700px] flex items-center justify-center">
                        {bikes.length > 0 ? (
                            ...
                            <div className="text-center text-gray-400">No bikes found for Vamok series.</div>
                        )}
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="flex justify-center lg:justify-end">
                        <div className="relative w-full max-w-[600px] h-[400px] rounded-3xl overflow-hidden flex items-center justify-center">
                            <img
                                src="https://www.raymon-bicycles.com/_next/image?url=https%3A%2F%2Fb2b.raymon-bicycles.com%2Fmedia%2Fe8%2F63%2F20%2F1746520528%2Fairok_bg.png&w=640&q=100"
                                alt="Vamok Action"
...
export default SeriesDetailVamok;
