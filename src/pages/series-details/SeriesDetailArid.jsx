...
const SeriesDetailArid = () => {
        ...
        const fetchBikes = async () => {
            try {
                const { data, error } = await supabase
                    .from('bicicletas')
                    .select('*')
                    .eq('serie_id', 19); // Arid ID

                if (error) throw error;
                setBikes(data || []);

            } catch (error) {
                console.error('Error fetching Arid bikes:', error);
            } finally {
                setLoading(false);
            }
        };
    ...
    if (loading) return <div className="h-screen flex items-center justify-center font-black uppercase tracking-tighter text-2xl">Loading Arid...</div>;

    const currentBike = bikes[activeIndex] || bikes[0];

    // Info for specs (using generic placeholders for now)
    const specs = currentBike ? [
        { label: 'Frame', value: currentBike.cuadro_material || 'Alloy 6061', icon: Circle },
        { label: 'Drivetrain', value: currentBike.transmision_modelo || 'Shimano Deore', icon: Cpu },
        { label: 'Wheels', value: currentBike.tamano_rueda || '27.5"', icon: Activity },
        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="relative text-white pb-32 overflow-hidden">
                ...
                <div className="absolute inset-0 z-0">
                    <img
                        src="https://www.raymon-bicycles.com/_next/image?url=https%3A%2F%2Fb2b.raymon-bicycles.com%2Fmedia%2F39%2F4f%2F3f%2F1747034794%2FArid_hero.png&w=1920&q=100"
                        alt="Background"
                ...
                <div className="w-full relative z-10 mb-12">
                    <div className="relative h-[400px] md:h-[600px] flex items-center justify-center">
                        {bikes.length > 0 ? (
                            ...
                            <div className="text-center text-gray-500 font-bold uppercase tracking-widest">No models available for the Arid series yet.</div>
                        )}
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="relative hidden lg:flex items-center justify-center lg:justify-end">
                        <div className="relative w-full max-w-[700px]">
                            <img
                                src="https://www.raymon-bicycles.com/_next/image?url=https%3A%2F%2Fb2b.raymon-bicycles.com%2Fmedia%2F57%2F6b%2Ffa%2F1747138031%2FFrame%20863.png&w=1920&q=75"
                                alt="Arid Push Your Limits"
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="hidden lg:flex justify-center lg:justify-start">
                        <div className="relative w-full max-w-[750px]">
                            <img
                                src="https://www.raymon-bicycles.com/_next/image?url=https%3A%2F%2Fb2b.raymon-bicycles.com%2Fmedia%2Fd9%2F80%2Fb3%2F1747138040%2FFrame%20864.png&w=1920&q=75"
                                alt="Arid Hard Core"
...
export default SeriesDetailArid;
