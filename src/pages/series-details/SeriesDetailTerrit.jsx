...
const SeriesDetailTerrit = () => {
        ...
        const fetchBikes = async () => {
            try {
                const { data, error } = await supabase
                    .from('bicicletas')
                    .select('*')
                    .eq('serie_id', 15); // Territ ID

                if (error) throw error;
                setBikes(data || []);

            } catch (error) {
                console.error('Error fetching Territ bikes:', error);
            } finally {
                setLoading(false);
            }
        };
    ...
    if (loading) return <div className="h-screen flex items-center justify-center font-black uppercase tracking-tighter text-2xl">Loading Territ...</div>;

    const currentBike = bikes[activeIndex] || bikes[0];

    // Kids bike specific specs
    const specs = currentBike ? [
        { label: 'Frame', value: currentBike.cuadro_material || 'Alloy 6061', icon: Circle },
        { label: 'Drivetrain', value: currentBike.transmision_modelo || 'Shimano Altus', icon: Cpu },
        { label: 'Wheels', value: currentBike.tamano_rueda || '24"', icon: Activity },
        { label: 'Brakes', value: currentBike.frenos_modelo || 'Disc Brakes', icon: Anchor },
    ] : [];
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <div className="relative text-white pb-32 overflow-hidden">
                {/* Background Image (Kids/Family focused hero) */}
                <div className="absolute inset-0 z-0">
                    <img
                        src="https://www.raymon-bicycles.com/_next/image?url=https%3A%2F%2Fb2b.raymon-bicycles.com%2Fmedia%2F0a%2Fd3%2F1c%2F1747034809%2FTerrit_hero.png&w=1200&q=100"
                        alt="Background"
                        ...
                        {bikes.length > 0 ? (
                            ...
                            >
                                {bikes.map((bike, index) => (
                                    <SwiperSlide key={slugify(bike.modelo)} className={`!w-[85vw] md:!w-[800px] !h-full flex items-center justify-center transition-all duration-700 ${index === activeIndex ? 'scale-110 opacity-100 z-10' : 'scale-75 opacity-40 blur-[1px]'}`}>
                                        {({ isActive }) => (
                            ...
                            <div className="text-center text-gray-500 font-bold uppercase tracking-widest">No models available for the Territ series yet.</div>
                        )}
                    </div>
                </div>
            ...
            {/* Marketing Section 1 - Adventure for Kids */}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="space-y-6 text-left lg:pr-12">
                        ...
                        <div className="text-lg text-gray-600 leading-relaxed text-left space-y-6">
                            ...
                            <p>
                                The slim aluminum frame and grippy all-round tires give you speed where you need it and the disc brakes give you control when you need it. For all those who want to push their limits on and off the road.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="relative hidden lg:flex items-center justify-center lg:justify-end">
                        <div className="relative w-full max-w-[700px]">
                            <img
                                src="https://www.raymon-bicycles.com/_next/image?url=https%3A%2F%2Fb2b.raymon-bicycles.com%2Fmedia%2Fa8%2F0b%2F45%2F1747139175%2FFrame%20867.png&w=1920&q=75"
                                alt="Territ Adventure"
            ...
            {/* Marketing Section 2 - Safety & Quality */}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="hidden lg:flex justify-center lg:justify-start">
                        <div className="relative w-full max-w-[750px]">
                            <img
                                src="https://www.raymon-bicycles.com/_next/image?url=https%3A%2F%2Fb2b.raymon-bicycles.com%2Fmedia%2F85%2F25%2F8d%2F1747139187%2FFrame%20868.png&w=1920&q=75"
                                alt="Territ Quality"
                    ...
                    <div className="space-y-6 text-left">
                        ...
                        <div className="text-lg text-gray-600 leading-relaxed text-left space-y-6">
                            ...
                            <p>
                                From the precise drivetrain to the reliable brakes, every component is chosen to provide a safe and exhilarating ride. Adventure starts here, and it starts with quality you can trust.
                            </p>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {bikes.length > 0 ? (
                        ...
                        <div className="col-span-full text-center text-gray-400 font-bold uppercase py-20">
                            More Territ models coming soon.
                        </div>
                    )}
                </div>
            </div>
...
export default SeriesDetailTerrit;
