        ...
        const fetchBikes = async () => {
            try {
                const { data, error } = await supabase
                    .from('bicicletas')
                    .select('*')
                    .eq('serie_id', 6); // Korak ID

                if (error) throw error;
                setBikes(data || []);
            } catch (error) {
                console.error('Error fetching Korak bikes:', error);
            } finally {
                setLoading(false);
            }
        };
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <div className="relative bg-black text-white pb-32 overflow-hidden">
                {/* Background Image - Placeholder for Korak background if different */}
                <div className="absolute inset-0 z-0">
                    <img
                        src="https://www.raymon-bicycles.com/_next/image?url=https%3A%2F%2Fb2b.raymon-bicycles.com%2Fmedia%2F16%2F5c%2F7b%2F1749728312%2FKorak_MainHeader.png&w=1920&q=100"
                        alt="Background"
                ...
                <div className="w-full relative z-10 mb-12">
                    <div className="relative h-[400px] md:h-[700px] flex items-center justify-center">
                        {bikes.length > 0 ? (
                            ...
                            <div className="text-center text-gray-400">No bikes found for Korak series.</div>
                        )}
                    </div>
                </div>
            ...
            {/* Marketing Section */}
            <div className="max-w-[1000px] mx-auto px-8 md:px-16 py-24 text-center">
                <h2 className="text-4xl md:text-5xl font-black text-black leading-tight mb-8">
                    Your everyday adventures<br />
                    <span className="text-gray-400">begins here.</span>
                </h2>
                ...
                <div className="text-lg text-gray-600 leading-relaxed space-y-6">
                    ...
                    <p className="font-bold text-black pt-4">
                        Your everyday adventures begin here.
                    </p>
                </div>
            </div>
...
export default SeriesDetailKorak;
