        ...
        const fetchBikes = async () => {
            try {
                const { data, error } = await supabase
                    .from('bicicletas')
                    .select('*')
                    .eq('serie_id', 8); // Norza (previously AirRay) ID

                if (error) throw error;
                setBikes(data || []);
            } catch (error) {
                console.error('Error fetching Norza bikes:', error);
            } finally {
                setLoading(false);
            }
        };
        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="relative text-white pb-32 overflow-hidden">
                ...
                <div className="absolute inset-0 z-0">
                    <img
                        src="https://www.raymon-bicycles.com/_next/image?url=https%3A%2F%2Fb2b.raymon-bicycles.com%2Fmedia%2F03%2Fd0%2F6b%2F1749728258%2FNorza_MainHeader.png&w=1200&q=100"
                        alt="Background"
                ...
                <div className="w-full relative z-10 mb-12">
                    <div className="relative h-[400px] md:h-[700px] flex items-center justify-center">
                        {bikes.length > 0 ? (
                            ...
                            <div className="text-center text-gray-400">No bikes found for Norza series.</div>
                        )}
                    </div>
                </div>
            ...
            <div className="max-w-[1000px] mx-auto px-4 py-24 text-center">
                <h2 className="text-4xl md:text-6xl font-black text-black leading-tight mb-12">
                    From city lights to <span className="text-gray-300">gravel<br />nights.</span>
                </h2>

                <div className="text-lg text-black leading-relaxed space-y-8 max-w-3xl mx-auto mb-12">
                    <p>
                ...
                <div className="flex justify-center">
                    <button className="bg-black text-white px-8 py-4 rounded-full font-bold uppercase tracking-widest hover:scale-105 transition-transform">
                        Join the waitlist
                    </button>
                </div>
            </div>
...
export default SeriesDetailNorza;
