...
const SeriesDetailYara = () => {
        ...
        const fetchBikes = async () => {
            try {
                const { data, error } = await supabase
                    .from('bicicletas')
                    .select('*')
                    .eq('serie_id', 18); // Yara ID

                if (error) throw error;
                setBikes(data || []);

            } catch (error) {
                console.error('Error fetching Yara bikes:', error);
            } finally {
                setLoading(false);
            }
        };
    ...
    if (loading) return <div className="h-screen flex items-center justify-center font-black uppercase tracking-tighter text-2xl">Loading Yara...</div>;
        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="relative text-white pb-32 overflow-hidden">
                ...
                <div className="absolute inset-0 z-0">
                    <img
                        src="https://www.raymon-bicycles.com/_next/image?url=https%3A%2F%2Fb2b.raymon-bicycles.com%2Fmedia%2Fd4%2F0c%2Fc9%2F1747034740%2FYara_hero.png&w=1920&q=100"
                        alt="Background"
                ...
                <div className="w-full relative z-10 mb-12">
                    <div className="relative h-[400px] md:h-[600px] flex items-center justify-center">
                        {bikes.length > 0 ? (
                            ...
                            <div className="text-center text-gray-500 font-bold uppercase tracking-widest">No models available for the Yara series yet.</div>
                        )}
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="relative hidden lg:flex items-center justify-center lg:justify-end">
                        <div className="relative w-full max-w-[700px]">
                            <img
                                src="https://www.raymon-bicycles.com/_next/image?url=https%3A%2F%2Fb2b.raymon-bicycles.com%2Fmedia%2Fcb%2Fe7%2F37%2F1747137423%2FYara_detail.png&w=1920&q=75"
                                alt="Yara Adventure"
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="hidden lg:flex justify-center lg:justify-start">
                        <div className="relative w-full max-w-[750px]">
                            <img
                                src="https://www.raymon-bicycles.com/_next/image?url=https%3A%2F%2Fb2b.raymon-bicycles.com%2Fmedia%2F99%2F33%2Fc3%2F1747137444%2FYara_Frame%20857.png&w=1920&q=75"
                                alt="Yara Suspension"
...
export default SeriesDetailYara;
